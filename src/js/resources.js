var Resources = {
   UnitSpriteSheet: new ex.Texture("img/UnitSpriteSheetNew.png"),
   SpiderSheet: new ex.Texture("img/SpiderSheet.png"),
   HeartSheet: new ex.Texture("img/HeartSheet.png"),
   UISheet: new ex.Texture("img/UISheet.png"),
